...
namespace Ejercicio_105
{
  internal class Program
  {
    ...
    {
      string cadenaNumero;
      Console.WriteLine("Ejercicio 105, Tablas");
      cadenaNumero= Input.IngresarPorTeclado("Ingrese el numero del cual quiere la tabla: ");
      Output.MostrarTabla(cadenaNumero);
